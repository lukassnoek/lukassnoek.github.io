...
In addition to teaching about MRI, I give lectures about the brain basis of emotion, cognitive computational neuroscience (e.g., the use of deep learning as computational models of the mind and brain), statistics, and (Python) programming. I try to make my teaching materials (programming notebooks, slides, etc.) publicly available as much as possible, as listed below.
